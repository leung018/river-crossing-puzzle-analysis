...
internal class GameRulesTest {
    ...
    fun `ClassicGameRules canGameContinue`() {
        ...
        assertTrue(
            ...
            "mother prevent father beat daughter"
        )

        assertFalse(ClassicGameRules.canGameContinue(setOf(MOTHER, SON)), "mother will beat son without father")
        assertTrue(ClassicGameRules.canGameContinue(setOf(MOTHER, SON, FATHER)), "father prevent mother beat son")
        ...
        assertTrue(ClassicGameRules.canGameContinue(setOf(DOG, FATHER, MASTER)), "master prevent dog biting others")
